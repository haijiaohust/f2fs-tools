...
void print_head(char *res)
{
	...
	char name[24][10] = {"util", "node", "data", "free", "valid", "dirty", "prefree", "lblk", "pblk", "drate", "node", "dent", "meta",
...
{
	char format[] = "%4ld %4ld %4ld %4ld %5ld %5ld %7ld %4ld %4ld %4ld%% %3ld %4ld %4ld %3ld %3ld %4ld %2ld %2ld %3ld %3ld %5ld %4ld %4ld";
	...
	while (1) {
		...
		sprintf(buf, format, util, used_node_blks, used_data_blks,
			free_segs, valid_segs, dirty_segs, prefree_segs,logical_blk_cnt, physical_blk_cnt, dedupe_rate,
